...
// // Rotas públicas
// const publicPaths = ["/", "/login", "/home", "/category", "/post", "/register"];
// const blockedWhenLoggedIn = ["/", "/login", "/home", "/category", "/post", "/register"];
// const adminPaths = ["/dashboard", "/create_category", "/create_post", "/edit_post", "/edit_category"];
...
//     const redirectPath = isAdmin ? "/dashboard" : `/login`;
...
//   if (token && isAdmin && (pathname.startsWith("/") || pathname === "/")) {
